...
create table dbo.Shell(
    ...
    PricePurchased decimal(6,2) not null constraint ck_Shell_PricePurchased_must_be_greater_than_0 check(PricePurchased > 0), --I purchase them at wholesale for 6$ each and sell them for 12.99$ each?
    DateSold date null, 
    PriceSold decimal(6,2) null, --I purchase them at wholesale for 6$ each and sell them for 12.99$ each?
